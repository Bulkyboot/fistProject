...
namespace Dell.Lead.WeApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IContributorsBusiness, ContributorsBusinessImplementation>();
            ...
            services.AddScoped<IContributorsRepository, ContributorsRepositoryImplementation>();
